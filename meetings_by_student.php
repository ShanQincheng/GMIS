...
<a href="search-student-privacy.php?search=students&searchStudentID=<?php echo $_GET['searchStudentID']; ?>&searchStudentGN=<?php echo $_GET['searchStudentGN']; ?>&searchStudentFN=<?php echo $_GET['searchStudentFN']; ?>">Go back</a>
